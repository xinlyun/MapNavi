...
public class Utils {
    ...
    public static String getAddressSimple(String string){
        ...
        char[] newChars = new char[name.length-pos];
    ...
    /**
     * @param str
     * @return 2DCode Bitmap
     * @throws WriterException
     */
    public static Bitmap Create2DCode(String str) throws Exception {
