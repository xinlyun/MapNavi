...
public interface GuideInfoExtraKey {
    ...
    public static final String ROUND_ABOUT_NUM = "ROUND_ABOUT_NUM";
    ...
    public static String authority = "com.xiaopeng.carprovider.provider";
    public final static int UsersSUCCESS = 1;
}
