...
import com.xiaopeng.amaplib.amap.offlinemap.OfflineChild;
import com.xiaopeng.xmapnavi.R;
import com.xiaopeng.xmapnavi.view.appwidget.selfview.MofflineChild;
 ...
 */
public class MofflineListAdapter extends BaseExpandableListAdapter implements ExpandableListView.OnGroupCollapseListener, ExpandableListView.OnGroupExpandListener {
    ...
    public MofflineListAdapter(List<OfflineMapProvince> provinceList,
...
//		return provinceList.get(groupPosition).getCityList().get(childPosition).getCity();
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            convertView = (RelativeLayout) RelativeLayout.inflate(
                    mContext, R.layout.offlinemap_group_new, null);
        }
        ...
        if (isOpen[groupPosition]) {
            group_image.setImageDrawable(mContext.getResources().getDrawable(
                    R.drawable.icon_up_left));
        } else {
            group_image.setImageDrawable(mContext.getResources().getDrawable(
                    R.drawable.icon_down_left));
        }
        return convertView;
    }
    ...
    public View getChildView(int groupPosition,
        ...
        if (convertView != null) {
            ...
            MofflineChild offLineChild = new MofflineChild(mContext, amapManager);
...
//		return groupPosition != 0 && groupPosition != 1 && groupPosition != 2;
    ...
    public final class ViewHolder {
        public MofflineChild mOfflineChild;
    }
