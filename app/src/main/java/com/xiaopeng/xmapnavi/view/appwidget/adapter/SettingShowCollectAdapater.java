 ...
 */
public class SettingShowCollectAdapater extends ArrayAdapter {
    private List<CollectItem> mCollectItems = new ArrayList<>();
    private OnClickRightItem mOnClickRightItem;
    public SettingShowCollectAdapater(Context context, int resource) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            view = LayoutInflater.from(getContext()).inflate(R.layout.layout_item_collect_in_setting, null);
            itemHolder.mTxName = (TextView) view.findViewById(R.id.tv_collect_name);
            itemHolder.mTxPoi = (TextView) view.findViewById(R.id.tv_collect_desc);
    ...
    public CollectItem getCollectItem(int posi){
        if (posi<mCollectItems.size()){
            return mCollectItems.get(posi);
        }else return null;
    }
