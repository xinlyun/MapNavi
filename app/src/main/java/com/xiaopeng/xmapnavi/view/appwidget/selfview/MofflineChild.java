...
public class MofflineChild implements View.OnClickListener, View.OnLongClickListener {
    ...
    private TextView mOffLineState;
    ...
    public MofflineChild(Context context, OfflineMapManager offlineMapManager) {
        mContext = context;
        initView();
    ...
    private void initView() {
        ...
        mOffLineChildView = inflater.inflate(R.layout.offlinemap_child_new, null);
        ...
        mOffLineState   = (TextView) mOffLineChildView.findViewById(R.id.tx_down_state);
    ...
    private void displayDefault() {
        ...
        mOffLineState.setText(R.string.download);
        mOffLineState.setTextColor(mContext.getResources().getColor(R.color.text_blue));
    }
...
//        mDownloadProgress.setText("等待中");
        mOffLineState.setText(R.string.download_waiting);
        mOffLineState.setTextColor(mContext.getResources().getColor(R.color.text_blue));
    }
...
//        mDownloadProgress.setText("下载出现异常");
        mOffLineState.setText(R.string.dowaload_error);
        mOffLineState.setTextColor(mContext.getResources().getColor(R.color.a3a3a3));
    }
    ...
    private void displayPauseStatus(int completeCode) {
        ...
        mOffLineState.setText(R.string.download_pause);
        mOffLineState.setTextColor(mContext.getResources().getColor(R.color.text_blue));
    }
    ...
    private void displaySuccessStatus() {
        ...
        mDownloadProgress.setTextColor(mContext.getResources().getColor(
                R.color.gary));
        mOffLineState.setText(R.string.download_complete);
        mOffLineState.setTextColor(mContext.getResources().getColor(R.color.a3a3a3));
    }
    ...
    private void displayUnZIPStatus(int completeCode) {
        ...
        mDownloadProgress.setTextColor(mContext.getResources().getColor(
                R.color.gary));
        mOffLineState.setText(R.string.download_uzip);
        mOffLineState.setTextColor(mContext.getResources().getColor(R.color.text_blue));
    }
